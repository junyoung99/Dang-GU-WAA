...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.CustomViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final CustomAdapter.CustomViewHolder holder, final int position) {
        ...
        holder.list_userName.setText(arrayList.get(position).userName);
        holder.list_userAddress.setText( arrayList.get(position).address);
        holder.list_userJob.setText("직업: " +arrayList.get(position).job);
        holder.list_userAge.setText("나이: " + arrayList.get(position).age);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder { //listview에서 만든 것들을 여기로 불러 놓을 거임
        ...
        TextView list_userAddress;
        TextView list_userJob;
        TextView list_userAge;
        Button button;
        ...
        public CustomViewHolder(@NonNull View itemView) {
            ...
            this.list_userName = itemView.findViewById(R.id.list_clientName);
            this.list_userAddress = itemView.findViewById(R.id.list_clientAddress);
            this.list_userJob = itemView.findViewById(R.id.list_clientJob);
            this.list_userAge = itemView.findViewById(R.id.list_clientAge);
